...
public class DetailActivity extends AppCompatActivity {
    ...
    private void populateUI(Sandwich sandwich) {
        ...
        alsoKnownAsTextView.setText(constructStringFromStringArray(sandwich.getAlsoKnownAs()));
        descriptionTextView.setText(sandwich.getDescription());
        originTextView.setText(sandwich.getPlaceOfOrigin());
        ingredientsTextView.setText(constructStringFromStringArray(sandwich.getIngredients()));
    }

    private String constructStringFromStringArray(List<String> strArray) {
        String s = "";
